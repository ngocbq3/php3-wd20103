...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/products/{id}/edit', [ProductController::class, 'edit'])->name('admin.products.edit'); //Hiển thị form sửa
    Route::put('/products/{id}/edit', [ProductController::class, 'update'])->name('admin.products.update'); //Lưu dữ liệu sửa vào database
